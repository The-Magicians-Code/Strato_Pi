...
def api():
    return jsonify({
        "motor0": {
            "power": round(ct(MOTOR_1, READ, MOTOR_POWER, 1)[0]*100.0, 2),
        ...
        "motor1": {
            "power": round(ct(MOTOR_2, READ, MOTOR_POWER, 1)[0]*100.0, 2)
        ...
        "motor2": {
            "power": round(ct(MOTOR_3, READ, MOTOR_POWER, 1)[0]*100.0, 2)
