...
def control():
    ...
    try:
        ...
        #control(1, WRITE, 8411, 95)
        #print(control(2, READ, 8411, 1))
        #control(2, WRITE, 8411, 95)
        #print(control(3, READ, 8411, 1))
        #control(3, WRITE, 8411, 95)
        ...
        logger.info(master.execute(1, cst.WRITE_SINGLE_REGISTER, 8502, output_value=50)) #Seadistab mootori sageduseks 10 Hz, all on veel näiteid erinevatest seadesuurustest
        time.sleep(3)
        ...
        logger.info(master.execute(1, cst.WRITE_SINGLE_REGISTER, 8502, output_value=100)) #Seadistab mootori sageduseks 4 Hz
        time.sleep(3)
        ...
        logger.info(master.execute(2, cst.WRITE_SINGLE_REGISTER, 8502, output_value=200)) #Seadistab mootori sageduseks 10 Hz, all on veel näiteid erinevatest seadesuurustest
        time.sleep(3)
        ...
        logger.info(master.execute(2, cst.WRITE_SINGLE_REGISTER, 8502, output_value=200)) #Seadistab mootori sageduseks 4 Hz
        time.sleep(3)
        ...
        logger.info(master.execute(3, cst.WRITE_SINGLE_REGISTER, 8502, output_value=50)) #Seadistab mootori sageduseks 10 Hz, all on veel näiteid erinevatest seadesuurustest
        time.sleep(3)
        ...
        logger.info(master.execute(3, cst.WRITE_SINGLE_REGISTER, 8502, output_value=50)) #Seadistab mootori sageduseks 4 Hz
        time.sleep(3)
